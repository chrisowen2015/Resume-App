...
export default function ContactForm() {
    return (
        <>
            <Box sx={{ margin: '0 5em 0 2em' }}>
                <TextField label="YOUR EMAIL" sx={{ width: '50%', borderRadius: 30 }} InputProps={{ sx: { borderRadius: 30 } }} component={Paper} />
                ...
                <TextField label="YOUR MESSAGE" multiline rows={9} sx={{ width: '100%', borderRadius: 3 }} InputProps={{ sx: { borderRadius: 3 } }} component={Paper} />
